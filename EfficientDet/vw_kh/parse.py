...
if __name__ == '__main__':
    parse_distance("../../../../Downloads/VisionWireless/data/result/indoor/distance/cal_distance_0_1.json")
    print(parse_xml("../../../../Downloads/VisionWireless/data/label/indoor/cal0_1.xml"))
